...
param_gaussian_kernel_width.build_values(1, 4.0, R_EXP)
...
xlabel('FPR')
ylabel('TPR')
title('Train ROC (Width=%.3f, C1=%.3f, C2=%.3f) ROC curve' % (kernel.get_width(), classifier.get_C1(), classifier.get_C2()),size=10)
...
xlabel('FPR')
ylabel('TPR')
title('Test ROC (Width=%.3f, C1=%.3f, C2=%.3f) ROC curve' % (kernel.get_width(), classifier.get_C1(), classifier.get_C2()),size=10)
